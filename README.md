# :shopping_cart: add-to-projects

![CI](https://github.com/stairwaytowonderland/add-to-projects/actions/workflows/ci.yaml/badge.svg)
![Linter](https://github.com/stairwaytowonderland/add-to-projects/actions/workflows/linter.yaml/badge.svg)
![CodeQL](https://github.com/stairwaytowonderland/add-to-projects/actions/workflows/codeql-analysis.yml/badge.svg)
![Coverage](./badges/coverage.svg)

[![GitHub latest release](https://img.shields.io/github/v/release/stairwaytowonderland/add-to-projects?include_prereleases&logo=rocket)](https://github.com/stairwaytowonderland/stairwaytowonderland/add-to-projects/releases)
[![GitHub last commit](https://img.shields.io/github/last-commit/stairwaytowonderland/add-to-projects?logo=git)](https://github.com/stairwaytowonderland/stairwaytowonderland/add-to-projects/commits/main)
[![GitHub license](https://img.shields.io/github/license/stairwaytowonderland/add-to-projects?logo=opensourceinitiative&logoColor=white)](https://github.com/stairwaytowonderland/stairwaytowonderland/add-to-projects/tree/main/LICENSE)
...
- [x] **:one: :clipboard: Create your repo:** Use this template to
[**Create your own action**](#clipboard-create-your-own-action)! :tada:
- [x] **:two: :label: Create some labels:** Run the [Create Labels](https://github.com/stairwaytowonderland/add-to-projects/actions/workflows/create-labels.yaml)
_workflow_ to create some additional useful labels.
- [ ] **:three: :bookmark: Create some issues:** Run the [Import Issues from CSV](https://github.com/stairwaytowonderland/add-to-projects/actions/workflows/import-csv-issues.yaml)
...
own repository:
    ...
    ```json
    {
        ...
        "author": "",
        "homepage": "https://github.com/stairwaytowonderland/add-to-projects",
        "repository": {
            "type": "git",
            "url": "git+https://github.com/stairwaytowonderland/add-to-projects.git"
        },
        "bugs": {
            "url": "https://github.com/stairwaytowonderland/add-to-projects/issues"
        },
        ...
    }
    ```
...
> [Actions tab](https://github.com/stairwaytowonderland/add-to-projects/actions)!
...
>
> See
> [Contributing Guidelines](https://github.com/stairwaytowonderland/add-to-projects?tab=contributing-ov-file#contributing-guidelines)
> for more information.
